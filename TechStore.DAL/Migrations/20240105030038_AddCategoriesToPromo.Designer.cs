...
namespace TechStore.DAL.Migrations
{
    ...
    [Migration("20240105030038_AddCategoriesToPromo")]
    partial class AddCategoriesToPromo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryPromoCode", b =>
                {
                    b.HasOne("TechStore.Domain.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TechStore.Domain.Models.PromoCode", null)
                        .WithMany()
